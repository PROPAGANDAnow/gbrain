...
| [graphify-memory](../../recipes/graphify-memory.md) | Infra | — | Add a persistent code-graph memory layer so agents can navigate project structure without re-reading the whole repo | 15 min |
