...
curl -s -X POST "$HONCHO_BASE_URL/v3/workspaces/list" -H 'Content-Type: application/json' -H 'Authorization: Bearer invalid' -d '{}'
```
...
```json
{
  ...
  "api_key": "optional-if-your-deployment-enforces-auth"
}
```
