...
to register. Ask which integrations the deployment needs (email, calendar, voice, Twitter). Notable additions include `graphify-memory` for persistent repo-structure memory alongside the brain.
