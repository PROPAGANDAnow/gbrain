...
- `https://raw.githubusercontent.com/PROPAGANDAnow/gbrain/master/AGENTS.md` — start here
- `https://raw.githubusercontent.com/PROPAGANDAnow/gbrain/master/llms.txt` — full doc map
- `https://raw.githubusercontent.com/PROPAGANDAnow/gbrain/master/llms-full.txt` — same map, inlined
...
to register. Ask which integrations the deployment needs (email, calendar, voice, Twitter). Notable additions include `graphify-memory` for durable repo-structure memory that is discoverable from both the CLI and MCP.
